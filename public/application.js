...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://fierce-brook-20545.herokuapp.com/'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var changeElementDisplay = function changeElementDisplay(elementClass, action) {
	  var displayStyle = '';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showMonstersTemplate = __webpack_require__(14);
	var showMonsterDetailTemplate = __webpack_require__(34);
	var monsterObject = __webpack_require__(35);

	var monster = new monsterObject.Monster();

	var getMonstersSuccess = function getMonstersSuccess(data) {
	  store.data = data;
	  ...
	  var showMonsterHTML = showMonstersTemplate({
	...
	var getMonstersFailure = function getMonstersFailure() {};

	var createMonsterSuccess = function createMonsterSuccess(data) {
	  getMonsters();
	  $('#create-monster-modal').modal('toggle');
	};

	var createMonsterFailure = function createMonsterFailure() {};

	var deleteMonsterSuccess = function deleteMonsterSuccess() {};

	var deleteMonsterFailure = function deleteMonsterFailure() {};

	var addHandlebarsEvents = function addHandlebarsEvents() {
	  ...
	  $('#delete-monster').on('click', function (event) {
	    ...
	    api.deleteMonster(id).then(deleteMonsterSuccess).catch(deleteMonsterFailure);
	  });
	};

	var setMonsterParams = function setMonsterParams(data) {
	  for (var key in monster) {
	    if (monster.hasOwnProperty(key)) {
	...
	var getMonsterSuccess = function getMonsterSuccess(data) {
	  ...
	  var showMonsterHTML = showMonsterDetailTemplate({
	    monster: monster
	  });
	...
	var getMonsterFailure = function getMonsterFailure() {};

	var updateMonsterSuccess = function updateMonsterSuccess() {
	  getMonsters();
	};

	var updateMonsterFailure = function updateMonsterFailure() {};

	var updateMonster = function updateMonster() {
	  var data = {
	    'monster': {}
	  };
	  for (var key in monster) {
	  ...
	  api.updateMonster(data).then(updateMonsterSuccess).catch(updateMonsterFailure);
	};

	var updateAndGetMonster = function updateAndGetMonster() {
	  var data = {
	    'monster': {}
	  };
	  for (var key in monster) {
	  ...
	  api.updateMonster(data).then(getMonsterOnUpdateSuccess).catch(updateMonsterFailure);
	};

	var getMonsterOnUpdateSuccess = function getMonsterOnUpdateSuccess() {
	  var id = monster.id;
	  api.getMonster(id).then(getMonsterSuccess).catch(getMonsterFailure);
	};

	var getMonster = function getMonster(id) {
	  api.getMonster(id).then(getMonsterSuccess).catch(getMonsterFailure);
	};

	var getMonsters = function getMonsters() {
	  api.getMonsters().then(getMonstersSuccess).catch(getMonstersFailure);
	};
	...
	module.exports = {
	  getMonstersSuccess: getMonstersSuccess,
	  getMonstersFailure: getMonstersFailure,
	  createMonsterSuccess: createMonsterSuccess,
	  createMonsterFailure: createMonsterFailure,
	  deleteMonsterSuccess: deleteMonsterSuccess,
	  deleteMonsterFailure: deleteMonsterFailure,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createMonster = function createMonster(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/monsters',
	    method: 'POST',
	    headers: {
	...
	var deleteMonster = function deleteMonster(id) {
	  return $.ajax({
	    url: config.apiOrigin + '/monsters/' + id,
	    method: 'DELETE',
	    headers: {
	...
	var updateMonster = function updateMonster(data) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	    return "<h3 class=\"lead\">Select a monster to interact with it!</h3>\n";
	},"3":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

	  return " <div class=\"col-xs-6 col-sm-2 col-sm-3 col-md-3 col-lg-2 text-center col-centered\">\n <h4>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "</h4>\n   <img class=\"monster-image-small view_monster "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.type : stack1), depth0))
	    + "_"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.mood : stack1), depth0))
	    + "_"
	    ...
	    return "<div class=\"col-md-4 col-centered text-center\">\n<h2>Welcome to PixlMonster!</h2>\n<p class=\"lead\">You currently have no monsters. <br> Why don't you create one?</p>\n<p class=\"lead\">But beware - monsters are hungry and will require your constant attention!</p>\n<p class=\"lead\">After you have created your monster, you will need to periodically feed and clean up after it. Failing to do so, will result in its certain doom...</p>\n<p class=\"lead\">The longer your monster remains alive, the bigger it will get!</p>\n\n</div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=depth0 != null ? depth0 : {};

	  return "\n"
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.monsters : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.monsters : depth0),{"name":"each","hash":{},"fn":container.program(3, data, 1, blockParams),"inverse":container.program(5, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div>\n<div class=\"row\">\n  <div class=\"img-wrapper col-xs-12 col-sm-10 col-md-10 col-lg-8 col-centered\">\n</div>\n</div>\n<div class=\"img-wrapper col-xs-12 col-sm-10 col-md-10 col-lg-8 col-centered\">\n  <img class=\"img-responsive "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.monster : depth0)) != null ? stack1.home : stack1), depth0))
	    + "\">\n  <div class=\"img-overlay\">\n    <img id=\"monster-image\" class=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.monster : depth0)) != null ? stack1.type : stack1), depth0))
	    + "_"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.monster : depth0)) != null ? stack1.mood : stack1), depth0))
	    + "_"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.monster : depth0)) != null ? stack1.status : stack1), depth0))
	    + " monster-size-"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.monster : depth0)) != null ? stack1.size : stack1), depth0))
	    + "\">\n  </div>\n  <div class=\"img-overlay-hunger\">\n    <div class=\"lead\">Hunger<meter low=\"3\" high=\"4\" max=\"5\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.monster : depth0)) != null ? stack1.hunger : stack1), depth0))
	    + "\" optimum=\"5\"></meter></div>\n  </div>\n  <div class=\"img-overlay-poop col-centered\">\n    <img id=\"poop-image\" class=\"img-responsive poop poop-"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.monster : depth0)) != null ? stack1.cleanliness : stack1), depth0))
	    + "\">\n  </div>\n</div>\n<div class=\"row\">\n  <img id=\"feed-monster\" class=\"food\">\n</div>\n<button id=\"delete-monster\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.monster : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-secondary\">Say Goodbye</button><br>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports) {
	...
	var Monster = function Monster(id, name, hunger, mood, cleanliness, type, updatedAt, eatRate, poopRate, boredRate, status, home, createdAt) {
	  this.id = id;
	  this.name = name;
	  this.hunger = hunger;
	  this.mood = mood;
	...
	Monster.prototype.hoursSinceUpdate = function () {
	  var today = new Date();
	  var updatedDate = new Date(this.updated_at);
	  var dateDiff = today.getTime() - updatedDate.getTime();
	  dateDiff /= 1000;
	  dateDiff /= 60;
	  dateDiff /= 60;
	...
	Monster.prototype.grow = function () {
	  var hours = this.hoursSinceCreated();
	  var size = hours / 24 - hours % 24;
	  if (size > 5) size = 5;
	  if (size < 0) size = 0;
	  return size;
	};
	...
	Monster.prototype.eatAndPoop = function () {
	  var hours = this.hoursSinceUpdate();
	  var startHunger = this.hunger;
	  var startCleanliness = this.cleanliness;
	  var eatRate = 1;
	  var poopRate = 1;
	  if (hours >= 2) {
	    this.hunger -= eatRate;
	  ...
	  if (this.hunger === startHunger && this.cleanliness === startCleanliness) return false;
	  return true;
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onGetMonsters = function onGetMonsters() {
	  event.preventDefault();
	  api.getMonsters().then(ui.getMonstersSuccess).catch(ui.getMonstersFailure);
	};

	var onCreateMonster = function onCreateMonster(event) {
	  event.preventDefault();
	  if (store.data.monsters.length < 3) {
	    var data = getFormFields(this);
	    api.createMonster(data).then(ui.createMonsterSuccess).catch(ui.createMonsterFailure);
	  }
	};

	var onGoBackToOverview = function onGoBackToOverview() {
	  ui.goBack();
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "01c12f27129cd1286dfcb755b4f55c48.jpg";
